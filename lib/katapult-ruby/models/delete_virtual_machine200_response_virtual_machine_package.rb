...
module KatapultAPI
  class DeleteVirtualMachine200ResponseVirtualMachinePackage
    attr_accessor :id
    ...
    attr_accessor :storage_in_gb

    attr_accessor :monthly_bandwidth_allowance_in_gb
    ...
    def self.openapi_types
      {
        ...
        :'icon' => :'DeleteVirtualMachine200ResponseVirtualMachinePackageIcon'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `KatapultAPI::DeleteVirtualMachine200ResponseVirtualMachinePackage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `KatapultAPI::DeleteVirtualMachine200ResponseVirtualMachinePackage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'ipv4_addresses')
        self.ipv4_addresses = attributes[:'ipv4_addresses']
      end
      ...
      if attributes.key?(:'storage_in_gb')
        self.storage_in_gb = attributes[:'storage_in_gb']
      end

      if attributes.key?(:'monthly_bandwidth_allowance_in_gb')
        self.monthly_bandwidth_allowance_in_gb = attributes[:'monthly_bandwidth_allowance_in_gb']
      end

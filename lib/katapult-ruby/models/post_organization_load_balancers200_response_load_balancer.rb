...
module KatapultAPI
  class PostOrganizationLoadBalancers200ResponseLoadBalancer
    attr_accessor :id
    ...
    def self.openapi_types
      {
        ...
        :'ip_address' => :'Array<PostOrganizationLoadBalancers200ResponseLoadBalancerIPAddress>',
        :'https_redirect' => :'Boolean',
        :'backend_certificate' => :'String',
        :'backend_certificate_key' => :'String',
        :'data_center' => :'PostOrganizationLoadBalancers200ResponseLoadBalancerDataCenter',
        :'enable_weighting' => :'Boolean',
        :'weights' => :'Array<PostOrganizationLoadBalancers200ResponseLoadBalancerWeights>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `KatapultAPI::PostOrganizationLoadBalancers200ResponseLoadBalancer` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `KatapultAPI::PostOrganizationLoadBalancers200ResponseLoadBalancer`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

...
module KatapultAPI
  ...
  class VirtualMachineFlexibleResources
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `KatapultAPI::VirtualMachineFlexibleResources` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `KatapultAPI::VirtualMachineFlexibleResources`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @cpu_cores.nil?
        invalid_properties.push('invalid value for "cpu_cores", cpu_cores cannot be nil.')
      end

      if @memory_in_gb.nil?
        invalid_properties.push('invalid value for "memory_in_gb", memory_in_gb cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @cpu_cores.nil?
      return false if @memory_in_gb.nil?
      true
    end

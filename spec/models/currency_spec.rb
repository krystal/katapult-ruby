...
# Unit tests for KatapultAPI::Currency
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe KatapultAPI::Currency do
  let(:instance) { KatapultAPI::Currency.new }

  describe 'test an instance of Currency' do
    it 'should create an instance of Currency' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(KatapultAPI::Currency)
    end
  end

...
# Unit tests for KatapultAPI::DNSRecord
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe KatapultAPI::DNSRecord do
  let(:instance) { KatapultAPI::DNSRecord.new }

  describe 'test an instance of DNSRecord' do
    it 'should create an instance of DNSRecord' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(KatapultAPI::DNSRecord)
    end
  end

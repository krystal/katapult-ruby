...
# Unit tests for KatapultAPI::Schedule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe KatapultAPI::Schedule do
  let(:instance) { KatapultAPI::Schedule.new }

  describe 'test an instance of Schedule' do
    it 'should create an instance of Schedule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(KatapultAPI::Schedule)
    end
  end
